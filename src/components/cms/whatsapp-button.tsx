/**
 * CAARD - Botón flotante de WhatsApp
 */
...
export function WhatsAppButton({ phoneNumber, message = "Hola, me gustaría obtener información sobre sus servicios de arbitraje." }: WhatsAppButtonProps) {
